    ...
    <div className="page">
      ...
      <div className="topwordsholder">
        <h4 className="topwords">
          mNeme uses space-repition theory to help students retain material for
          longer than traditional cramming
        </h4>
      </div>
      ...
      <div className="study">
        <h3 className="studywords">
          Students have seen an <h3 className="percent">87%</h3> improvement in
          their grades and continue to use mNeme through out all stages of their
          education
        </h3>
      </div>

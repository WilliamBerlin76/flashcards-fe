...
export default function Privacy() {
  return (
    <div>
      ...
      <h3>Introduction</h3>
      <p>
        mNeme (“we” or “us” or “our”) respects the privacy of our users (“user”
        or “you”). This Privacy Policy explains how we collect, use, disclose,
        and safeguard your information when you visit our website
        [mneme-staging.netlify.com], including any other media form, media
        ...
        posting the updated Privacy Policy on the Site, and you waive the right
        to receive specific notice of each such change or modification. You are
        ...
        such revised Privacy Policy is posted. This Privacy Policy was generated
        by Termly’s Privacy Policy Generator.
      </p>
      ...
      <p>
        The Site may by default access your Facebook basic account information,
      ...
      <p>
        ...
        Privacy Policy. By using the Site, you agree to be bound by our Cookie
        Policy.]
      </p>
      ...
      <p>
        ...
        content and better understand online activity. By accessing the Site
        [,our mobile application,], you consent to the collection and use of
      ...
      <p>
        ...
        this Privacy Policy. Most web browsers and some mobile operating systems
        ...
        browsing activities monitored and collected. If you set the DNT signal
        on your browser, we will respond to such DNT browser signals.
      </p>
      ...
      <p>
        ...
        account with the Site, you have the right to request removal of unwanted
        data that you publicly post on the Site. To request removal of such
        ...
        not publicly displayed on the Site, but please be aware that the data
      ...
      <p>lambdaflashcards@gmail.com</p>
    </div>
  );
}
